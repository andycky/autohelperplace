...
docker rm selenium
#docker rm selenium2
docker run -d -p 4444:4444 -e SE_NODE_SESSION_TIMEOUT=31536000 -e SE_SESSION_REQUEST_TIMEOUT=31536000 --name --net=host selenium selenium/standalone-chrome
...
docker run -d -p 5000:5000 -v /home/andy/autohelperplace:/python-docker --name --net=host autohelper autohelper
